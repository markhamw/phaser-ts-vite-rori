...
export default class Preloader extends Phaser.Scene {
   ...
   */
        ...
        this.load.audio('peoplewithouthope', ["assets/music/peoplewithouthope.mp3"])
        this.load.audio('ruinedworld', ["assets/music/ruinedworld.mp3"])
        this.load.audio('brinkoftime', ["assets/music/brinkoftime.mp3"])
        this.load.audio('beach', ["assets/sounds/beach.mp3"])
        this.load.atlas('icons', "assets/icons.png", "assets/icons.json")
        this.load.audio('gato', ["assets/music/gatossong.mp3"])
        this.load.audio('maintitle', ["assets/music/maintitle.mp3"])
        this.load.audio('robo', ["assets/music/robo.mp3"])
        this.load.audio('ayla', ["assets/music/ayla.mp3"])
    }
